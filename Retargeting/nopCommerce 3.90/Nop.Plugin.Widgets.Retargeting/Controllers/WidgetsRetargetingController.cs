...
namespace Nop.Plugin.Widgets.Retargeting.Controllers
{
    public class WidgetsRetargetingController : BasePluginController
    {
        ...
        private readonly string _urlLink;
            ...
            )
        {
            ...
            _urlLink= _storeContext.CurrentStore.Url;
        }
...
//          var urlLink = "/";
            ...
            model.feedContent.Add(_urlLink+"widgetsretargeting/productstockfeed");
            model.feedContent.Add(_urlLink+"widgetsretargeting/productstaticfeed");
            model.feedContent.Add(_urlLink+"widgetsretargeting/productcronfeed");
        ...
        [NopHttpsRequirement(SslRequirement.No)]
        public ActionResult ProductStaticFeed()
        {
            var fileName = "retargeting.csv";
            ...
            {
                var output = ProductStockFeed();
                return output;
            }
        }

        [NopHttpsRequirement(SslRequirement.No)]
        public JsonResult ProductCronFeed()
        {
            var fileName = "retargeting.csv";
            var result = string.Empty;
